...
const Attendance: React.FC = () => {
  ...
  // Create attendance after authentication
  const createAttendance = async (newAttendance: CreateAttendanceRequest) => {
    try {
      await AttendanceApi.createAttendance(newAttendance, credentials.username, credentials.password)
      await fetchAttendances()
      setError(null)
